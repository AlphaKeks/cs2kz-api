...
#[derive(Default, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Into, Deref, sqlx::Type)]
#[sqlx(transparent)]
...
impl fmt::Display for Permission {
	fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
		f.write_str(match self {
			Permission::Bans => "bans",
			Permission::Records => "records",
			Permission::Servers => "servers",
			Permission::Maps => "maps",
